...
namespace Microsoft.AspNetCore.SignalR
{
    ...
    /// </summary>
    public class HubAuthorizationContext : HubCallerContext
    {
        private readonly HubConnectionContext _connection;

        public HubAuthorizationContext(HubConnectionContext connection)
        {
        ...
        public string HubMethodName { get; internal set; }
        public IReadOnlyList<object> HubMethodArguments { get; internal set; }
    }
}
